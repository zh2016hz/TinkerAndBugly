...
import com.xiaoniu.finance.tinkernewdemo.tinker.MyLogImp;
import com.xiaoniu.finance.tinkernewdemo.tinker.TinkerManager;

@SuppressWarnings("unused")
@DefaultLifeCycle(application = "com.aaa.tinker.MyApplication",// application类名。只能用字符串，这个MyApplication文件是不存在的，但可以在AndroidManifest.xml的application标签上使用（name）
